...
import type { StackNavigatorParamList, StreamChatGenerics } from '../components/ChatComponents/types';

type ChannelListScreenNavigationProp = StackNavigationProp<StackNavigatorParamList, 'ChannelListScreen'>;
...
export const ChannelInfoOverlayProvider: React.FC<{
    ...
    return (
        <ChannelInfoOverlayContext.Provider value={channelInfoOverlayContext as ChannelInfoOverlayContextValue}>
            {children}
