...
import { Avatar, Spinner, useTheme, vw } from 'stream-chat-expo';
...
export const MessageSearchList: React.FC<MessageSearchListProps> = React.forwardRef((props, scrollRef: any) => {
    const {
