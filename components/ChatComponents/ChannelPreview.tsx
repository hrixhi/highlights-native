...
import { useChannelInfoOverlayContext } from '../../ChatContext/ChannelInfoOverlayContext';
...
const ChannelPreview: React.FC<ChannelPreviewMessengerProps<StreamChatGenerics>> = (props) => {
    const { channel } = props;
