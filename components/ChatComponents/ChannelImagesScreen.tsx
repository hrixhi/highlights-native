...
import { Picture } from '../../assets/chatIcons';
import { usePaginatedAttachments } from '../../ChatHooks/usePaginatedAttachments';
...
export const ChannelImagesScreen: React.FC<ChannelImagesScreenProps> = ({
    ...
    const [stickyHeaderDate, setStickyHeaderDate] = useState(Dayjs(messages?.[0]?.created_at).format('MMM YYYY'));
