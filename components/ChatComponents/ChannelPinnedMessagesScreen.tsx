...
import { usePaginatedPinnedMessages } from '../../ChatHooks/usePaginatedPinnedMessages';
import { Message } from '../../assets/chatIcons';
...
type ChannelPinnedMessagesScreenRouteProp = RouteProp<StackNavigatorParamList, 'ChannelFilesScreen'>;
