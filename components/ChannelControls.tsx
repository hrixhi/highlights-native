            ...
            >
                ...
                <View style={styles.colorBar}>
                    <TouchableOpacity
                        ...
                        <Text style={{ color: '#a2a2ac', lineHeight: 20, fontSize: 11 }}>
                    ...
                    option === 'All' ?
                        <View style={{ backgroundColor: '#fff', flexDirection: 'row' }}>
                            <View style={{ flex: 1, backgroundColor: '#f4f4f6', paddingLeft: 10 }}>
                                <Text style={{ fontSize: 11, lineHeight: 25, color: '#2f2f3c' }} ellipsizeMode='tail'>
                                    Name
                                </Text>
                            </View>
                            <View style={{ flex: 1, backgroundColor: '#f4f4f6', paddingLeft: 10 }}>
                            ...
                            }
                            {
                                option === 'Create' ?
                                    <View
                                        ...
                                        <Text style={{ color: '#a2a2ac', fontSize: 11, backgroundColor: '#fff' }}>
