...
import { StackNavigatorParamList } from '../components/ChatComponents/types';
    ...
    navigation.dispatch((state) => {
        ...
        if (routes?.length) {
            ...
            if (lastStackRoute.name === 'ChannelScreen') {
                const params = lastStackRoute.params as StackNavigatorParamList['ChannelScreen'] | undefined;
